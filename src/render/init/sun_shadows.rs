use wgpu::{
    BindGroup, BindGroupLayout, Buffer, Device, PipelineLayout, TextureView, util::DeviceExt,
};

use crate::{
    render::{
        camera::{CameraUniform, OrthographicCamera},
...
impl SunShadow {
    pub fn new(device: &Device, distance: f32, layout: &BindGroupLayout) -> SunShadow {
        ...
        let sun_shadows_lod_camera_buffer =
        ...
        let sun_shadow_texture_lod = device.create_texture(&wgpu::TextureDescriptor {
            ...
            }, //ultra 8192, high 4096, medium 2048, low 1024, very low 512
            mip_level_count: 1,
            sample_count: 1,
        ...
        let sun_shadow_texture_lod_view =
            sun_shadow_texture_lod.create_view(&wgpu::TextureViewDescriptor::default());
...
impl InitSunShadow {
    pub async fn new(device: &Device) -> InitSunShadow {
        ...
        let sun_shadow_bind_group_layout =
        ...
        let sun_shadow_textures_bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                entries: &[
                    //lod0
        ...
        let sun_shadow_textures_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
                    resource: wgpu::BindingResource::TextureView(&sun_shadow_lod_0.texture_view),
                },
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: wgpu::BindingResource::Sampler(&sun_shadow_lod_0.texture_sampler),
                },
                wgpu::BindGroupEntry {
                    binding: 2,
                    resource: wgpu::BindingResource::Sampler(
                        &sun_shadow_lod_0.texture_distance_sampler,
                    ),
                },
                wgpu::BindGroupEntry {
                    binding: 3,
                    resource: wgpu::BindingResource::Buffer(
                        sun_shadow_lod_0.camera_buffer.as_entire_buffer_binding(),
                    ),
                },
                wgpu::BindGroupEntry {
                    binding: 4,
                    resource: wgpu::BindingResource::TextureView(&sun_shadow_lod_1.texture_view),
                },
                wgpu::BindGroupEntry {
                    binding: 5,
                    resource: wgpu::BindingResource::Sampler(&sun_shadow_lod_1.texture_sampler),
                },
                wgpu::BindGroupEntry {
                    binding: 6,
                    resource: wgpu::BindingResource::Sampler(
                        &sun_shadow_lod_1.texture_distance_sampler,
                    ),
                },
                wgpu::BindGroupEntry {
                    binding: 7,
                    resource: wgpu::BindingResource::Buffer(
                        sun_shadow_lod_1.camera_buffer.as_entire_buffer_binding(),
                    ),
                },
                wgpu::BindGroupEntry {
                    binding: 8,
                    resource: wgpu::BindingResource::TextureView(&sun_shadow_lod_2.texture_view),
                },
                wgpu::BindGroupEntry {
                    binding: 9,
                    resource: wgpu::BindingResource::Sampler(&sun_shadow_lod_2.texture_sampler),
                },
                wgpu::BindGroupEntry {
                    binding: 10,
                    resource: wgpu::BindingResource::Sampler(
                ...
                wgpu::BindGroupEntry {
                    binding: 11,
                    resource: wgpu::BindingResource::Buffer(
                        sun_shadow_lod_2.camera_buffer.as_entire_buffer_binding(),
                    ),
                },
                wgpu::BindGroupEntry {
                    binding: 12,
                    resource: wgpu::BindingResource::TextureView(&sun_shadow_lod_3.texture_view),
                },
                wgpu::BindGroupEntry {
                    binding: 13,
                    resource: wgpu::BindingResource::Sampler(&sun_shadow_lod_3.texture_sampler),
                },
                wgpu::BindGroupEntry {
                    binding: 14,
                    resource: wgpu::BindingResource::Sampler(
                ...
                wgpu::BindGroupEntry {
                    binding: 15,
                    resource: wgpu::BindingResource::Buffer(
                        sun_shadow_lod_3.camera_buffer.as_entire_buffer_binding(),
                    ),
                },
            ],
        ...
        let sun_shadow_pipeline_layout =
            device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
                ...
                bind_group_layouts: &[&sun_shadow_bind_group_layout],
                push_constant_ranges: &[],
            });

        let sun_shadow_render_pipeline =
