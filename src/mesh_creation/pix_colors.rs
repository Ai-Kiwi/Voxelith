...
pub fn calculate_pix_color(pixel_type : PixelTypes,x : i32, y : i32, z : i32) -> (Color, Material) {
    ...
    let pixel_data: (Color, Material) = match pixel_type {
        ...
        PixelTypes::Dirt => {
            if code > 0.95 {
                (Color::new(79, 76, 74, 255),Material::new(0,0,0))
            }else if code > 0.75 {
                (Color::new(92, 58, 17, 255),Material::new(0,0,0))
            }else if code > 0.5 {
                (Color::new(82, 49, 11, 255),Material::new(0,0,0))
            }else if code > 0.25 {
                (Color::new(99, 59, 13, 255),Material::new(0,0,0))
            } else {
                (Color::new(117, 71, 19, 255),Material::new(0,0,0))
            }
        },
        PixelTypes::Stone => {
            if code > 0.75 {
        ...
        PixelTypes::Sand => {
            if code > 0.75 {
                (Color::new(227, 177, 77, 255),Material::new(0,0,0))
            }else if code > 0.5 {
                (Color::new(201, 152, 52, 255),Material::new(0,0,0))
            }else if code > 0.25 {
                (Color::new(191, 141, 38, 255),Material::new(0,0,0))
            } else {
                (Color::new(222, 157, 22, 255),Material::new(0,0,0))
            }
        },
        PixelTypes::Snow => {
            if code > 0.95 {
