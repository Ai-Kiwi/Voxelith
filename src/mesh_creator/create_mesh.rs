...
use crate::{
    mesh_creation::create_triangles::{TriangleSide, add_triangle},
    mesh_creator::{MeshCreator, VoxelData},
    render::wgpu::RenderState,
    utils::{Color, Material, Vertex},
};
...
impl MeshCreator {
    pub fn vertices_from_voxel_color_hashmap(
        voxel_data: &HashMap<(i32, i32, i32), VoxelData>,
    ) -> Vec<Vertex> {
